data:extend({
  ...
  { -- twBeacon1
    type = "beacon",
    name = "twBeacon1",
    icon = "__TarawindBeacons2__/graphics/icons/beacon.png",
	icon_size = 32,
    ...
    base_picture =
    {
      filename = "__TarawindBeacons2__/graphics/entity/beacon/beacon-base.png",
      width = 116,
      height = 93,
    ...
    animation =
    {
      filename = "__TarawindBeacons2__/graphics/entity/beacon/beacon-antenna1.png",
      width = 54,
      height = 50,
      line_length = 8,
      frame_count = 32,
    ...
    animation_shadow =
    {
      filename = "__TarawindBeacons2__/graphics/entity/beacon/beacon-antenna-shadow.png",
      width = 63,
      height = 49,
      line_length = 8,
      frame_count = 32,
    ...
    {
      filename = "__TarawindBeacons2__/graphics/entity/beacon/beacon-radius-visualization.png",
      width = 12,
      height = 12
    },
  ...
  { -- twBeacon2
    ...
    animation =
    {
      filename = "__TarawindBeacons2__/graphics/entity/beacon/beacon-antenna2.png",
      width = 54,
      height = 50,
      line_length = 8,
      frame_count = 32,
  ...
  { -- twBeacon3
    ...
    animation =
    {
      filename = "__TarawindBeacons2__/graphics/entity/beacon/beacon-antenna3.png",
      width = 54,
      height = 50,
      line_length = 8,
      frame_count = 32,
  ...
  { -- twBeacon4
    ...
    animation =
    {
      filename = "__TarawindBeacons2__/graphics/entity/beacon/beacon-antenna4.png",
      width = 54,
      height = 50,
      line_length = 8,
      frame_count = 32,
  ...
  { -- twBeacon5
    ...
    animation =
    {
      filename = "__TarawindBeacons2__/graphics/entity/beacon/beacon-antenna5.png",
      width = 54,
      height = 50,
      line_length = 8,
      frame_count = 32,
  ...
  { -- twBeacon6
    ...
    animation =
    {
      filename = "__TarawindBeacons2__/graphics/entity/beacon/beacon-antenna6.png",
      width = 54,
      height = 50,
      line_length = 8,
      frame_count = 32,
  ...
  { -- twBeacon7
    ...
    animation =
    {
      filename = "__TarawindBeacons2__/graphics/entity/beacon/beacon-antenna7.png",
      width = 54,
      height = 50,
      line_length = 8,
      frame_count = 32,
